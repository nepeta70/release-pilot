...
{
    Task InsertAsync(Promotion promotion, IDbTransaction transaction, CancellationToken cancellationToken);
    Task UpdateAsync(Promotion promotion, IDbTransaction transaction, CancellationToken cancellationToken);
